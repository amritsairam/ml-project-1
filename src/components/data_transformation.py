...
#function responsible for data transformation
    def get_data_transformer_object(self):
        try:
            ...
            logging.info('numerical features {}'.format(numerical_columnns))

            logging.info('categorical features'.format(categorical_columns))

            preprocessor=ColumnTransformer(
                [
                    ('num_pipeline',num_pipeline,numerical_columnns),#the basic syntax is the name followed by function and which part to apply to 
